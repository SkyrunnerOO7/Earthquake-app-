...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        magnitudeView.setText(currentEarthquake.getMagnitude().toString());
        ...
        offsetLocationView.setText(currentEarthquake.getOffsetLocation());
    ...
    /**
     * private method for getting
     * the correct color according to the value of mag
     */
